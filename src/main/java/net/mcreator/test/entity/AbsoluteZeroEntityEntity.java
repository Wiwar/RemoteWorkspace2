...
import net.mcreator.test.procedures.AbZeroEntityIdleProcedure;
import net.mcreator.test.entity.renderer.AbsoluteZeroEntityRenderer;
...
public class AbsoluteZeroEntityEntity extends MushokuModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.3f)).build("absolute_zero_entity").setRegistryName("absolute_zero_entity");

	public AbsoluteZeroEntityEntity(MushokuModElements instance) {
		super(instance, 43);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AbsoluteZeroEntityRenderer.ModelRegisterHandler());
