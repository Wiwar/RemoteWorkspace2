...
@OnlyIn(Dist.CLIENT)
public class PushProjRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PushProjItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}
	...
	public static class CustomRender extends EntityRenderer<PushProjItem.ArrowCustomEntity> {
		...
		@Override
		public void render(PushProjItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(PushProjItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
