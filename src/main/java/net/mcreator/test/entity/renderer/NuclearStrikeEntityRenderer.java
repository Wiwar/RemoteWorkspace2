...
@OnlyIn(Dist.CLIENT)
public class NuclearStrikeEntityRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NuclearStrikeEntityItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<NuclearStrikeEntityItem.ArrowCustomEntity> {
		...
		@Override
		public void render(NuclearStrikeEntityItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(NuclearStrikeEntityItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
