...
@OnlyIn(Dist.CLIENT)
public class WaterArrowProjRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WaterArrowProjItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}
	...
	public static class CustomRender extends EntityRenderer<WaterArrowProjItem.ArrowCustomEntity> {
		...
		@Override
		public void render(WaterArrowProjItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(WaterArrowProjItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
