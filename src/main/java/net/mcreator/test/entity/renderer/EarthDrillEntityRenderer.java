...
import net.mcreator.test.entity.EarthDrillEntityEntity;

@OnlyIn(Dist.CLIENT)
public class EarthDrillEntityRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EarthDrillEntityEntity.entity,
