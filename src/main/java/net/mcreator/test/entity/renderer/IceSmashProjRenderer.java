...
@OnlyIn(Dist.CLIENT)
public class IceSmashProjRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IceSmashProjItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}
	...
	public static class CustomRender extends EntityRenderer<IceSmashProjItem.ArrowCustomEntity> {
		...
		@Override
		public void render(IceSmashProjItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(IceSmashProjItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
