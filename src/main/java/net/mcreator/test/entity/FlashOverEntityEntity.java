...
import net.mcreator.test.procedures.FlashOverIdleProcedure;
import net.mcreator.test.entity.renderer.FlashOverEntityRenderer;
...
public class FlashOverEntityEntity extends MushokuModElements.ModElement {
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			FlashOverIdleProcedure.executeProcedure(Stream
