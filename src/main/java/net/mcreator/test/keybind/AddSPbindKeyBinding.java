...
import net.mcreator.test.procedures.AddSPProcedure;
...
public class AddSPbindKeyBinding extends MushokuModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public AddSPbindKeyBinding(MushokuModElements instance) {
		super(instance, 239);
	...
	public void initElements() {
		keys = new KeyBinding("key.mushoku.add_s_pbind", GLFW.GLFW_KEY_L, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			AddSPProcedure.executeProcedure(Stream
