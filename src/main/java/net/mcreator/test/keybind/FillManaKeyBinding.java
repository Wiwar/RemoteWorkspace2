...
import net.mcreator.test.procedures.SetManaProcedure;
...
public class FillManaKeyBinding extends MushokuModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public FillManaKeyBinding(MushokuModElements instance) {
		super(instance, 38);
	...
	public void initElements() {
		keys = new KeyBinding("key.mushoku.fill_mana", GLFW.GLFW_KEY_R, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SetManaProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
