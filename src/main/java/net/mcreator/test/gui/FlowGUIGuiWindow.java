...
public class FlowGUIGuiWindow extends ContainerScreen<FlowGUIGui.GuiContainerMod> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Flow", 72, 4, -16777216);
		this.font.drawString(ms, "Reflect Incoming attacks", 16, 33, -16777216);
		this.font.drawString(ms, "back at your attacker", 16, 45, -16777216);
		this.font.drawString(ms, "Availible Skill Points " + ((entity.getCapability(MushokuModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new MushokuModVariables.PlayerVariables())).TechniqueSP) + "", 5, 18, -16777216);
		this.font.drawString(ms, "(Unlock for 50 skill points)", 12, 95, -16777216);
		this.font.drawString(ms, "Bind Skill", 60, 106, -16777216);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 44, this.guiTop + 73, 82, 20, new StringTextComponent("Unlock Flow"), e -> {
			if (true) {
		...
		this.addButton(new Button(this.guiLeft + 9, this.guiTop + 117, 72, 20, new StringTextComponent("Skill One"), e -> {
			if (true) {
		...
		this.addButton(new Button(this.guiLeft + 92, this.guiTop + 117, 72, 20, new StringTextComponent("Skill Two"), e -> {
			if (true) {
		...
		this.addButton(new Button(this.guiLeft + 44, this.guiTop + 140, 82, 20, new StringTextComponent("Skill Three"), e -> {
			if (true) {
