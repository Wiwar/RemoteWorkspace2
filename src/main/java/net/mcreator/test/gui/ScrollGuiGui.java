...
import net.mcreator.test.procedures.ScrollInscribtionProcedure;
...
public class ScrollGuiGui extends MushokuModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public ScrollGuiGui(MushokuModElements instance) {
		super(instance, 66);
