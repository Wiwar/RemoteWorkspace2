...
public class WaterArrowProjItem extends MushokuModElements.ModElement {
	@ObjectHolder("mushoku:water_arrow_proj")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_water_arrow_proj").setRegistryName("projectile_water_arrow_proj");

	public WaterArrowProjItem(MushokuModElements instance) {
		super(instance, 18);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WaterArrowProjRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("water_arrow_proj");
		}
