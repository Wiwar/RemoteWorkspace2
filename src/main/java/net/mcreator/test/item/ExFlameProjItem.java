...
import net.mcreator.test.procedures.ExFlameProjHitProcedure;
import net.mcreator.test.entity.renderer.ExFlameProjRenderer;
...
public class ExFlameProjItem extends MushokuModElements.ModElement {
	@ObjectHolder("mushoku:ex_flame_proj")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_ex_flame_proj").setRegistryName("projectile_ex_flame_proj");

	public ExFlameProjItem(MushokuModElements instance) {
		super(instance, 140);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ExFlameProjRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void func_230299_a_(BlockRayTraceResult blockRayTraceResult) {
			...
			ExFlameProjHitProcedure.executeProcedure(Stream
