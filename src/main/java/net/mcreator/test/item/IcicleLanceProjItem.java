...
import net.mcreator.test.procedures.IcicleLanceHitProcedure;
import net.mcreator.test.entity.renderer.IcicleLanceProjRenderer;
...
public class IcicleLanceProjItem extends MushokuModElements.ModElement {
	@ObjectHolder("mushoku:icicle_lance_proj")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_icicle_lance_proj").setRegistryName("projectile_icicle_lance_proj");

	public IcicleLanceProjItem(MushokuModElements instance) {
		super(instance, 35);
		FMLJavaModLoadingContext.get().getModEventBus().register(new IcicleLanceProjRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("icicle_lance_proj");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(IceSmashProjItem.block);
		}
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			IcicleLanceHitProcedure.executeProcedure(Stream
