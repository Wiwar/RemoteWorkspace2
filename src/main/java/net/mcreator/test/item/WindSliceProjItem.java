...
import net.mcreator.test.procedures.WindSliceProjHitProcedure;
import net.mcreator.test.entity.renderer.WindSliceProjRenderer;
...
public class WindSliceProjItem extends MushokuModElements.ModElement {
	@ObjectHolder("mushoku:wind_slice_proj")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_wind_slice_proj").setRegistryName("projectile_wind_slice_proj");

	public WindSliceProjItem(MushokuModElements instance) {
		super(instance, 135);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WindSliceProjRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("wind_slice_proj");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			WindSliceProjHitProcedure.executeProcedure(Stream
