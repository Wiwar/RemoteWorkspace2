...
public class FlameSliceProjItem extends MushokuModElements.ModElement {
	...
	@ObjectHolder("mushoku:flame_slice_proj")
	public static final Item block = null;

	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_flame_slice_proj").setRegistryName("projectile_flame_slice_proj");

	public FlameSliceProjItem(MushokuModElements instance) {
		super(instance, 133);

		FMLJavaModLoadingContext.get().getModEventBus().register(new FlameSliceProjRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		...
		public ItemRanged() {
			...
			setRegistryName("flame_slice_proj");
		}
