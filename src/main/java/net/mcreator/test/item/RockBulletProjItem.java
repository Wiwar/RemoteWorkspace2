...
import net.mcreator.test.procedures.RockBulletHitProcedure;
import net.mcreator.test.entity.renderer.RockBulletProjRenderer;
...
public class RockBulletProjItem extends MushokuModElements.ModElement {
	@ObjectHolder("mushoku:rock_bullet_proj")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_rock_bullet_proj").setRegistryName("projectile_rock_bullet_proj");

	public RockBulletProjItem(MushokuModElements instance) {
		super(instance, 45);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RockBulletProjRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("rock_bullet_proj");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			RockBulletHitProcedure.executeProcedure(Stream
