...
import net.mcreator.test.procedures.FireballprojHitProcedure;
import net.mcreator.test.entity.renderer.FireBallProjRenderer;
...
public class FireBallProjItem extends MushokuModElements.ModElement {
	@ObjectHolder("mushoku:fire_ball_proj")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_fire_ball_proj").setRegistryName("projectile_fire_ball_proj");

	public FireBallProjItem(MushokuModElements instance) {
		super(instance, 50);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FireBallProjRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("fire_ball_proj");
		}
