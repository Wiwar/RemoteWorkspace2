...
import net.mcreator.test.procedures.PushProjEfProcedure;
import net.mcreator.test.entity.renderer.PushProjRenderer;
...
public class PushProjItem extends MushokuModElements.ModElement {
	@ObjectHolder("mushoku:push_proj")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_push_proj").setRegistryName("projectile_push_proj");

	public PushProjItem(MushokuModElements instance) {
		super(instance, 84);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PushProjRenderer.ModelRegisterHandler());
	}
