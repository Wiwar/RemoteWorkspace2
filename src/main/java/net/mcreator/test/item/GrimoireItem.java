...
public class GrimoireItem extends MushokuModElements.ModElement {
	@ObjectHolder("mushoku:grimoire")
	public static final Item block = null;

	public GrimoireItem(MushokuModElements instance) {
		super(instance, 27);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof GrimoireGuiGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Grimoire");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GrimoireGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
