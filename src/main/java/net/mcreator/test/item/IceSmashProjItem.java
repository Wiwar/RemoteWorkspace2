...
import net.mcreator.test.procedures.IceSmashHitProcedure;
import net.mcreator.test.entity.renderer.IceSmashProjRenderer;
...
public class IceSmashProjItem extends MushokuModElements.ModElement {
	@ObjectHolder("mushoku:ice_smash_proj")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_ice_smash_proj").setRegistryName("projectile_ice_smash_proj");

	public IceSmashProjItem(MushokuModElements instance) {
		super(instance, 17);
		FMLJavaModLoadingContext.get().getModEventBus().register(new IceSmashProjRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("ice_smash_proj");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			IceSmashHitProcedure.executeProcedure(Stream
