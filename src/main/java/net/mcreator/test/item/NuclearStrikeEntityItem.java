...
import net.mcreator.test.procedures.NuclearStrikeEntityHitProcedure;
import net.mcreator.test.entity.renderer.NuclearStrikeEntityRenderer;
...
public class NuclearStrikeEntityItem extends MushokuModElements.ModElement {
	@ObjectHolder("mushoku:nuclear_strike_entity")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_nuclear_strike_entity").setRegistryName("projectile_nuclear_strike_entity");

	public NuclearStrikeEntityItem(MushokuModElements instance) {
		super(instance, 154);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NuclearStrikeEntityRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("nuclear_strike_entity");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void func_230299_a_(BlockRayTraceResult blockRayTraceResult) {
			...
			NuclearStrikeEntityHitProcedure.executeProcedure(Stream
