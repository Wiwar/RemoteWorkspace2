...
import net.mcreator.test.procedures.TornadoImpactHitProcedure;
import net.mcreator.test.entity.renderer.TornadoImpactProjRenderer;
...
public class TornadoImpactProjItem extends MushokuModElements.ModElement {
	@ObjectHolder("mushoku:tornado_impact_proj")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_tornado_impact_proj").setRegistryName("projectile_tornado_impact_proj");

	public TornadoImpactProjItem(MushokuModElements instance) {
		super(instance, 124);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TornadoImpactProjRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("tornado_impact_proj");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			TornadoImpactHitProcedure.executeProcedure(Stream
